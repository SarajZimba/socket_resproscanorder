...
#         orders = ScanPayOrder.objects.filter(Q(outlet=outlet_name) & ~Q(state="Completed") & ~Q(state = "Cancelled"))
...
#         orders = ScanPayOrder.objects.filter(Q(outlet=outlet_name) & Q(table_no=table_no) & ~Q(state="Completed") & ~Q(state="Cancelled"))
...
#         flag = True
#         order_queryset = ScanPayOrder.objects.filter(Q(table_no=table_no) & Q(outlet=outlet) & (Q(state='Pending') | Q(state='Cooked') | Q(state='Accepted')))
