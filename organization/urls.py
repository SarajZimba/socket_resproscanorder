...
# from .views import MailRecipientList,MailRecipientDetail,MailRecipientCreate,MailRecipientUpdate,MailRecipientDelete, EndDayReportList, DailyEndDayReportList
# urlpatterns += [
...
# path('daily-report/', DailyEndDayReportList.as_view(), name='daily_endday_report_list'),
...
urlpatterns += [
    ...
    path('branch/<int:pk>/update/', BranchUpdate.as_view(), name='branch_update'),
    path('branch/delete', BranchDelete.as_view(), name='branch_delete'),
    path('create-multiple-terminals/', views.create_multiple_terminals, name='create_multiple_terminals'),
...
urlpatterns += [
    ...
    path('table/<int:pk>/update/', TableUpdate.as_view(), name='table_update'),
    path('table/delete', TableDelete.as_view(), name='table_delete'),
    path('create-multiple-tables/', views.create_multiple_tables, name='create_multiple_tables'),
]
